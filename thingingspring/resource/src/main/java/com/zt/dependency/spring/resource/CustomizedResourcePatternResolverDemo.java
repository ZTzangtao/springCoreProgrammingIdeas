...
public class CustomizedResourcePatternResolverDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //读取当前package 对应的所有的 .java 文件
        // *.java
        String currentPackagePath = System.getProperty("user.dir") + "\\thingingspring\\resource\\src\\main\\java\\com\\zt\\dependency\\spring\\resource";
